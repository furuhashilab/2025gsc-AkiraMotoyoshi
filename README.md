...
- **QGIS3.44**：距離計測、街灯密度分析、地図作成 ,2025-2026
- **OpenStreetMap (OSM)**：道路・信号・横断歩道・街灯データ ,2025-2026
- **Strava（無料版）**：歩行ログ（GPX）取得、移動速度・停止時間の分析 ,2025-2026
- **ChatGPT5.2**：研究設計、手順作成、分析補助、コーディング補助 ,2025-2026
